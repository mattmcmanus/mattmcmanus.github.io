...
let handler = exports.handler = (() => {
  var _ref = _asyncToGenerator(function* (event, context, callback) {
    let request = new _micropubRequest2.default(event);
    try {
      let tokenResponse = yield request.verifyToken();
    } catch (e) {
      console.error(e);
    }
...
var _micropubRequest = __webpack_require__(1);

var _micropubRequest2 = _interopRequireDefault(_micropubRequest);
...
class MicropubRequest {
  ...
  verifyToken() {
    ...
    return _asyncToGenerator(function* () {
      let bearer = _this.headers.authorization;
      ...
      let res;
      try {
        res = yield (0, _nodeFetch2.default)(TOKEN_ENDPOINT, {
          headers: {
...
exports.default = MicropubRequest;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_https__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_https___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_https__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_zlib__ = __webpack_require__(7);
